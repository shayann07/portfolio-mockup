...
export const AnimatedRaindrops = () => {
  ...
  return (
    ...
    >
      ...
      {/* Raindrops with negative delays so they start mid-fall */}
      <div className="absolute box-border caret-transparent outline-[oklab(0.708_0_0_/_0.5)] bg-[linear-gradient(oklab(0.714_0.117894_-0.165257_/_0.4)_0%,oklab(0.827_0.0705884_-0.0958033_/_0.2)_50%,rgba(0,0,0,0)_100%)] h-[70.3989px] opacity-[0.381002] left-[75.7402%] md:opacity-[0.264347] raindrop" style={{ animationDelay: "-2s" }}></div>
      <div className="absolute box-border caret-transparent outline-[oklab(0.708_0_0_/_0.5)] bg-[linear-gradient(oklab(0.714_0.117894_-0.165257_/_0.4)_0%,oklab(0.827_0.0705884_-0.0958033_/_0.2)_50%,rgba(0,0,0,0)_100%)] h-[65.9211px] opacity-[0.544318] left-[97.5348%] md:opacity-[0.0700206] raindrop" style={{ animationDelay: "-5.2s" }}></div>
      <div className="absolute box-border caret-transparent outline-[oklab(0.708_0_0_/_0.5)] bg-[linear-gradient(oklab(0.714_0.117894_-0.165257_/_0.4)_0%,oklab(0.827_0.0705884_-0.0958033_/_0.2)_50%,rgba(0,0,0,0)_100%)] h-[126.977px] opacity-[0.210014] left-[63.272%] md:opacity-[0.543296] raindrop" style={{ animationDelay: "-3.4s" }}></div>
      <div className="absolute box-border caret-transparent outline-[oklab(0.708_0_0_/_0.5)] bg-[linear-gradient(oklab(0.714_0.117894_-0.165257_/_0.4)_0%,oklab(0.827_0.0705884_-0.0958033_/_0.2)_50%,rgba(0,0,0,0)_100%)] h-[72.2779px] opacity-[0.30992] left-[86.1823%] md:opacity-[0.268495] raindrop" style={{ animationDelay: "-6.6s" }}></div>
      <div className="absolute box-border caret-transparent outline-[oklab(0.708_0_0_/_0.5)] bg-[linear-gradient(oklab(0.714_0.117894_-0.165257_/_0.4)_0%,oklab(0.827_0.0705884_-0.0958033_/_0.2)_50%,rgba(0,0,0,0)_100%)] h-[106.442px] opacity-[0.463085] left-[77.4306%] md:opacity-[0.0150873] raindrop" style={{ animationDelay: "-1.8s" }}></div>
      <div className="absolute box-border caret-transparent outline-[oklab(0.708_0_0_/_0.5)] bg-[linear-gradient(oklab(0.714_0.117894_-0.165257_/_0.4)_0%,oklab(0.827_0.0705884_-0.0958033_/_0.2)_50%,rgba(0,0,0,0)_100%)] h-[123.753px] opacity-[0.351131] left-[20.3425%] md:opacity-[0.37736] raindrop" style={{ animationDelay: "-4s" }}></div>
      <div className="absolute box-border caret-transparent outline-[oklab(0.708_0_0_/_0.5)] bg-[linear-gradient(oklab(0.714_0.117894_-0.165257_/_0.4)_0%,oklab(0.827_0.0705884_-0.0958033_/_0.2)_50%,rgba(0,0,0,0)_100%)] h-[147.584px] opacity-[0.388888] left-[22.0169%] md:opacity-[0.392846] raindrop" style={{ animationDelay: "-7.2s" }}></div>
      <div className="absolute box-border caret-transparent outline-[oklab(0.708_0_0_/_0.5)] bg-[linear-gradient(oklab(0.714_0.117894_-0.165257_/_0.4)_0%,oklab(0.827_0.0705884_-0.0958033_/_0.2)_50%,rgba(0,0,0,0)_100%)] h-[50.4072px] opacity-[0.510634] left-[78.6591%] md:opacity-[0.189187] raindrop" style={{ animationDelay: "-0.4s" }}></div>
      <div className="absolute bg-[linear-gradient(oklab(0.714_0.117894_-0.165257_/_0.4)_0%,oklab(0.827_0.0705884_-0.0958033_/_0.2)_50%,rgba(0,0,0,0)_100%)] box-border caret-transparent h-[64.2111px] opacity-[0.387677] outline-[oklab(0.708_0_0_/_0.5)] left-[35.3392%] md:opacity-[0.594783] raindrop" style={{ animationDelay: "-5.6s" }}></div>
      <div className="absolute bg-[linear-gradient(oklab(0.714_0.117894_-0.165257_/_0.4)_0%,oklab(0.827_0.0705884_-0.0958033_/_0.2)_50%,rgba(0,0,0,0)_100%)] box-border caret-transparent h-[123.215px] opacity-[0.424034] outline-[oklab(0.708_0_0_/_0.5)] left-[99.1798%] md:opacity-[0.542715] raindrop" style={{ animationDelay: "-2.8s" }}></div>
      <div className="absolute bg-[linear-gradient(oklab(0.714_0.117894_-0.165257_/_0.4)_0%,oklab(0.827_0.0705884_-0.0958033_/_0.2)_50%,rgba(0,0,0,0)_100%)] box-border caret-transparent h-[89.2356px] opacity-[0.332222] outline-[oklab(0.708_0_0_/_0.5)] left-[12.4572%] md:opacity-[0.115783] raindrop" style={{ animationDelay: "-6s" }}></div>
      <div className="absolute bg-[linear-gradient(oklab(0.714_0.117894_-0.165257_/_0.4)_0%,oklab(0.827_0.0705884_-0.0958033_/_0.2)_50%,rgba(0,0,0,0)_100%)] box-border caret-transparent h-[110.236px] opacity-[0.583836] outline-[oklab(0.708_0_0_/_0.5)] left-[74.6917%] md:opacity-[0.522195] raindrop" style={{ animationDelay: "-3.2s" }}></div>
      <div className="absolute bg-[linear-gradient(oklab(0.714_0.117894_-0.165257_/_0.4)_0%,oklab(0.827_0.0705884_-0.0958033_/_0.2)_50%,rgba(0,0,0,0)_100%)] box-border caret-transparent h-[94.2761px] opacity-[0.179769] outline-[oklab(0.708_0_0_/_0.5)] left-[38.3092%] md:opacity-[0.134754] raindrop" style={{ animationDelay: "-7.4s" }}></div>
      <div className="absolute bg-[linear-gradient(oklab(0.714_0.117894_-0.165257_/_0.4)_0%,oklab(0.827_0.0705884_-0.0958033_/_0.2)_50%,rgba(0,0,0,0)_100%)] box-border caret-transparent h-[90.5667px] opacity-[0.492642] outline-[oklab(0.708_0_0_/_0.5)] left-[87.8439%] md:opacity-[0.22661] raindrop" style={{ animationDelay: "-1.6s" }}></div>
      <div className="absolute bg-[linear-gradient(oklab(0.714_0.117894_-0.165257_/_0.4)_0%,oklab(0.827_0.0705884_-0.0958033_/_0.2)_50%,rgba(0,0,0,0)_100%)] box-border caret-transparent h-[74.9886px] opacity-[0.457657] outline-[oklab(0.708_0_0_/_0.5)] left-[89.8333%] md:opacity-[0.0615218] raindrop" style={{ animationDelay: "-4.8s" }}></div>
