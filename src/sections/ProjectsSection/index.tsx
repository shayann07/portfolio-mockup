...
const LeafBloomIcon = () => (
  <svg width="28" height="28" viewBox="0 0 1436.83 1282.42" fill="none" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
    <defs>
      <style>{`.cls-1{fill:none;}.cls-2{clip-path:url(#clip-path-leaf-projects);}.cls-3{fill:url(#linear-gradient-leaf-projects);}.cls-4{clip-path:url(#clip-path-2-leaf-projects);}.cls-5{fill:url(#linear-gradient-2-leaf-projects);}`}</style>
      <clipPath id="clip-path-leaf-projects" transform="translate(-2105.77 -1205.71)">
      ...
      <linearGradient id="linear-gradient-leaf-projects" x1="551.45" y1="1318.68" x2="225.82" y2="40.47" gradientUnits="userSpaceOnUse">
        <stop offset="0" stopColor="currentColor" stopOpacity="0.4" />
        <stop offset="1" stopColor="currentColor" stopOpacity="1" />
      </linearGradient>
      <clipPath id="clip-path-2-leaf-projects" transform="translate(-2105.77 -1205.71)">
      ...
      <linearGradient id="linear-gradient-2-leaf-projects" x1="568" y1="1193.96" x2="938.22" y2="-287.94" xlinkHref="#linear-gradient-leaf-projects" />
    </defs>
    <g className="cls-2">
