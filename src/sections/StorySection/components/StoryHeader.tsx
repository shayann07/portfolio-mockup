export const StoryHeader = () => {
  return (
    <div className="box-border caret-transparent outline-[oklab(0.708_0_0_/_0.5)] text-center mb-24">
      <div className="box-border caret-transparent inline-block outline-[oklab(0.708_0_0_/_0.5)] mb-6 group cursor-pointer">
        ...
        <div className="bg-[linear-gradient(to_right,rgba(0,0,0,0)_0%,oklch(0.714_0.203_305.504)_50%,rgba(0,0,0,0)_100%)] box-border caret-transparent h-[3px] outline-[oklab(0.708_0_0_/_0.5)] mt-4 transition-all duration-500 ease-[cubic-bezier(0.34,1.56,0.64,1)] origin-center will-change-transform group-hover:scale-[1.07]"></div>
      </div>
