...
export const TimelineItem = (props: TimelineItemProps) => {
  return (
    ...
    >
      ...
      <div
        className={`box-border caret-transparent outline-[oklab(0.708_0_0_/_0.5)] w-auto ml-14 md:w-[calc(50%_-_48px)] md:ml-0 ${props.variant === "mb-16 md:flex-row" || props.variant === "md:flex-row" ? "md:pr-6" : "md:pl-6"}`}
      >
        <motion.div
